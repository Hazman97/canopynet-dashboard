<template>
  <aside
    class="flex flex-col space-y-2 border-r-2 border-primary bg-sidebar p-2 text-[#abc0c0] transition-all duration-300 rounded-r-2xl"
    :class="collapsed ? 'w-20 items-center' : 'w-72'"
